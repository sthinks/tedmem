                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="inner text-center">
                            <SectionTitle
                                classes = "text-center"
                                slogan = "Bülten ve yayınlarından haberdar olmak için "
                                title = "Kayıt Olabilirsiniz"
                            />
                            <div className="newsletter-form newsletter-form-style-1 mt--60 mt_md--30 mt_sm--30 position-relative">
                                <div className="input-box text-start">
                                    <input className="large-input-box" type="name" placeholder="Ad Soyad ..." />
                            ...
                            <div className="newsletter-form newsletter-form-style-1 mt--60 mt_md--30 mt_sm--30 position-relative">
                                <div className="input-box text-start">
                                    <input className="large-input-box" type="name" placeholder="Kurum ..." />
                                    <div className="mail-icon">
                                    </div>
                                </div>
                            </div>
                            <div className="newsletter-form newsletter-form-style-1 mt--60 mt_md--30 mt_sm--30 position-relative">
                                <div className="input-box text-start">
                                    ...
                                    <button className="edu-btn">Kayıt Ol<i className="icon-arrow-right-line-right"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
