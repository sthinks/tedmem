...
import MemNedir from "../../assets/images/corporate/memnedir.jpg";
import BizKimiz from "../../assets/images/corporate/bizkimiz.jpg";
import Amac from "../../../../public/images/corporate/amac.jpg";
import Yola from "../../../../public/images/corporate/yola.jpg";
            ...
            <div className="row" style={{marginTop:"50px"}}>  
                {
                  corporateList.map((item) => (
                    <div className="col-lg-6 col-sm-12" href="content" key={item.title}> 
                      <a href={window.screen.width <= 991 ? "#content" : "#a"}>
                          <div className="corporate-card" onClick={() => filterHandler(item.slug)}  style={{ backgroundImage: `url(${item.image})` }}>
          ...
          <div className="col-lg-6" id="content">
            <div className="inner mt_md--40 mt_sm--40">
              <div className="description mt--40 mt_md--20 mt_sm--20" id="biz">
                     {filter &&
                        <>
                          <div className="corporate-header-title" >{filter[0].title}</div>
                          <div className="corporate-content-text"
