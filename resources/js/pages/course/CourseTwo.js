...
import { FaSchool, FaVirus, FaScroll, FaMicrophone, FaHandRock, FaHandsHelping, FaGlasses } from "react-icons/fa";
                    ...
                    <div className="container">
                        <div className="row d-flex justify-content-center" style={{marginBottom:'70px'}}>
                            {
                                    ...
                                    <>
                                        <div className="col-md-2 col-sm-6 mb-2">
                                            <a href={window.screen.width <= 991 ? "#card-content" : "#a"}>
                                                <button onClick={() => handleSekme(item.year)} className="btn btn-lg btn-block course-button-top">                                                
                                                        {item.year}                                                    
                                                </button>
                                            </a>
                                        </div>
                                ...
                                <div className="col-md-2 col-sm-6 mb-2">
                                    <a href={window.screen.width <= 991 ? "#card-content" : "#a"}>
                                            <button onClick={() => setSekme([])} className="btn btn-lg btn-block course-button-top">Tümü</button>
                                    </a>
                                </div>
                        </div>
                        ...
                        {sekme?.length > 0 ? (
                            <div className="d-flex justify-content-center">
                                <PaginationOne totalPosts={sekme?.length} postPerPage={postPerPage} setCurrentPage={setCurrentPage} currentPage={currentPage} />
                            </div>
                        ) : (
                                <div className="d-flex justify-content-center">
